...
import static example.com.myapplication.PermissionHandler.Utils.convertListToArray;
...
public abstract class PermissionHandlerActivity extends AppCompatActivity implements ActivityCompat
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PermissionHandlerActivity.this);
